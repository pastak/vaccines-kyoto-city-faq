...
function App() {
  return (
    <div className="App">
      ...
      <section>
        このウェブページは
        <a href="https://vaccines-kyoto-city.jp/#faq" target="_blank" rel="noreferrer">
          京都市新型コロナワクチン接種ポータルサイトのよくあるお問合せについて
        </a>
        のPDFをOCR読み取り(画像の自動読み取り)をした結果を掲載したものです。
        <br />
        全ての情報については京都市のウェブサイトを確認するようにしてください。
        <br />
        誤字・脱字を見つけた場合は
        <a href="https://github.com/pastak/vaccines-kyoto-city-faq">GithubでPull Requestやissue</a>
        を作成するか、Twitterで
        <a href="https://twitter.com/pastak" target="_blank" rel="noreferrer">
          @pastak
        </a>
        にお知らせください。
        <br />
      ...
      <section>
        <ul>
          ...
          <li>
            <a
              target="_blank"
              href="https://vaccines-kyoto-city.jp/assets/dl/yokuaru030427.pdf"
              rel="noreferrer"
            >
              元PDFへのリンク
            </a>{' '}
